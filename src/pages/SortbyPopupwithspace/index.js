                  ...
                  <Stack className="h-[826px] relative md:w-[100%] sm:w-[100%] w-[39%]">
                    <div className="flex flex-col items-center justify-start m-[auto] w-[100%]">
                      <div className="flex sm:flex-col flex-row sm:gap-[8px] items-start justify-between w-[100%]">
                        ...
                        <Stack className="bg-gray_201 h-[826px] relative rounded-radius8 sm:w-[100%] w-[50%]">
                          <div className="absolute bg-gray_201 flex flex-col md:h-[auto] sm:h-[auto] h-[max-content] inset-[0] items-center justify-start m-[auto] py-[8px] rounded-radius8 w-[auto]">
                            <Stack className="h-[818px] relative rounded-radius8 w-[100%]">
                              <div className="bg-gray_201 h-[826px] m-[auto] py-[8px] rounded-radius8 w-[100%]"></div>
                              ...
                              <div className="absolute flex flex-col h-[max-content] inset-[0] items-center justify-start m-[auto] w-[auto]">
                                <div className="flex flex-col items-center justify-start w-[100%]">
                                  ...
                                  <Stack className="h-[55px] mt-[3px] relative w-[100%]">
                                    ...
                                    <div className="absolute bg-gray_201 bottom-[0] flex flex-col h-[50px] md:h-[auto] sm:h-[auto] inset-x-[0] items-center justify-start mx-[auto] px-[12px] py-[8px] rounded-bl-[0] rounded-br-[0] rounded-tl-[8px] rounded-tr-[8px] sm:w-[100%] w-[216px]">
                                      <Input
                                        className="font-medium p-[0] text-[13px] text-left placeholder:text-light_blue_A700 text-light_blue_A700 w-[100%]"
                                        wrapClassName="flex w-[200px]"
                                        name="Button One"
