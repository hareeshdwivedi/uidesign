                  ...
                  <Stack className="h-[826px] relative md:w-[100%] sm:w-[100%] w-[39%]">
                    <div className="flex flex-col items-center justify-start m-[auto] w-[100%]">
                      <div className="flex sm:flex-col flex-row sm:gap-[8px] items-start justify-between w-[100%]">
                        ...
                        <Stack className="h-[826px] relative rounded-radius8 sm:w-[100%] w-[50%]">
                          <div className="absolute bg-gray_101 flex flex-col md:h-[auto] sm:h-[auto] h-[max-content] inset-[0] items-center justify-start m-[auto] py-[8px] rounded-radius8 w-[auto]">
                            <Stack className="h-[818px] relative rounded-radius8 w-[100%]">
                              <div className="bg-gray_101 h-[826px] m-[auto] py-[8px] rounded-radius8 w-[100%]"></div>
                    ...
                    <div className="absolute border border-gray_900_19 border-solid flex flex-col inset-x-[0] items-center justify-start mx-[auto] rounded-radius8 shadow-bs top-[4%] w-[65%]">
                      <div className="bg-white_A700 flex flex-col gap-[15px] items-center justify-start rounded-radius8 shadow-bs w-[100%]">
                        <Input
                          className="font-medium p-[0] text-[15px] placeholder:text-gray_900 text-gray_900 text-left w-[100%]"
                          wrapClassName="flex sm:mx-[0] w-[100%]"
                          name="Group1081"
                          ...
                          shape="CustomBorderTL7"
                          size="3xl"
                          variant="OutlineGray90019_1"
                        ></Input>
                        <Stack className="h-[620px] relative w-[100%]">
                          <Line className="bg-bluegray_200 h-[128px] ml-[auto] mr-[3px] my-[auto] rounded-radius2 w-[4px]" />
                          <Stack className="absolute h-[620px] inset-[0] justify-center m-[auto] w-[100%]">
                            <div className="absolute flex flex-col gap-[16px] h-[max-content] inset-y-[0] items-start justify-start left-[5%] my-[auto] w-[auto]">
                              ...
                              <div className="flex flex-col gap-[16px] items-start justify-start w-[auto]">
                                ...
                                <div className="flex flex-col gap-[12px] items-start justify-start w-[auto]">
                                  <CheckBox
                                    className="font-normal leading-[normal] not-italic text-[10px] text-gray_900_a2 text-left"
                                  ...
                                  <div className="flex flex-row gap-[12px] items-center justify-start w-[auto]">
                                    <div className="border border-gray_900_26 border-solid h-[18px] rounded-radius4 w-[18px]"></div>
                                    <Text
                                      className="bg-purple_51 font-normal not-italic px-[6px] py-[2px] rounded-radius85 text-gray_900_a2 text-left w-[auto]"
                                      variant="body3"
                                    >
                                      api.contactrm
                                    </Text>
                                  ...
                                  <div className="flex flex-row gap-[12px] items-center justify-start w-[auto]">
                                    <div className="border border-gray_900_26 border-solid h-[18px] rounded-radius4 w-[18px]"></div>
                                    <Text
                                      className="bg-blue_51 font-normal not-italic px-[6px] py-[2px] rounded-radius85 text-gray_900_a2 text-left w-[auto]"
                                      variant="body3"
                                    >
                                      Restrictive APIs
                                    </Text>
                            ...
                            <div className="absolute bg-white_A700 border border-gray_900_14 border-solid bottom-[0] flex flex-col inset-x-[0] items-end justify-start mx-[auto] p-[12px] rounded-bl-[8px] rounded-br-[8px] rounded-tl-[0] rounded-tr-[0] w-[100%]">
                              <div className="flex flex-row gap-[4px] items-center justify-start ml-[auto] mr-[4px] w-[auto]">
                                <Button
