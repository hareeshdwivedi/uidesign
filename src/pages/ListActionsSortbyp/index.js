            ...
            <Stack className="h-[918px] relative w-[100%]">
              ...
              <Stack className="absolute h-[918px] inset-[0] justify-center m-[auto] w-[100%]">
                <Stack className="h-[918px] m-[auto] w-[100%]">
                  ...
                  <Stack className="absolute bg-deep_purple_51 bottom-[0] h-[826px] inset-x-[0] mx-[auto] rounded-radius8 w-[19%]">
                    <div className="absolute bg-deep_purple_51 flex flex-col md:h-[auto] sm:h-[auto] h-[max-content] inset-[0] items-center justify-start m-[auto] py-[8px] rounded-radius8 w-[auto]">
                      <Stack className="h-[818px] relative rounded-radius8 w-[100%]">
                        <div className="bg-deep_purple_51 h-[826px] m-[auto] py-[8px] rounded-radius8 w-[100%]"></div>
                        ...
                        <div className="absolute flex flex-col h-[max-content] inset-[0] items-center justify-start m-[auto] w-[auto]">
                          <div className="flex flex-col items-center justify-start w-[100%]">
                            ...
                            <Stack className="h-[55px] mt-[3px] relative w-[100%]">
                              ...
                              <div className="absolute bg-deep_purple_51 bottom-[0] flex flex-col h-[50px] md:h-[auto] sm:h-[auto] inset-x-[0] items-center justify-start mx-[auto] px-[12px] py-[8px] rounded-bl-[0] rounded-br-[0] rounded-tl-[8px] rounded-tr-[8px] sm:w-[100%] w-[216px]">
                                <Input
                                  className="font-medium p-[0] text-[13px] text-left placeholder:text-light_blue_A700 text-light_blue_A700 w-[100%]"
                                  wrapClassName="flex w-[200px]"
                                  name="Button One"
                ...
                <div className="absolute flex sm:flex-col flex-row sm:gap-[40px] items-start justify-between right-[3%] top-[6%] w-[60%]">
                  <div className="flex flex-col items-center justify-start sm:mt-[0] mt-[63px] rounded-radius8 md:w-[100%] sm:w-[100%] w-[45%]">
                    <Stack className="h-[157px] relative rounded-radius8 w-[100%]">
                      <div className="absolute bg-white_A700 border border-gray_900_19 border-solid flex flex-col gap-[18px] h-[max-content] inset-y-[0] items-center justify-start left-[0] my-[auto] rounded-radius8 shadow-bs w-[89%]">
                        ...
                        <Line className="bg-gray_900_63 h-[1px] mb-[103px] w-[100%]" />
                      </div>
