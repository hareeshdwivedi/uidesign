      ...
      <Stack className="bg-gray_50 font-inter h-[1024px] mx-[auto] overflow-auto relative w-[100%]">
        <Stack className="absolute bottom-[0] h-[1529px] inset-x-[0] mx-[auto] w-[100%]">
          ...
          <div className="absolute bg-gray_900_87 flex flex-col inset-x-[0] items-center justify-start mx-[auto] p-[388px] sm:px-[20px] md:px-[40px] top-[0] w-[100%]">
            <div className="bg-white_A700 flex flex-col gap-[19px] justify-start py-[20px] rounded-radius8 shadow-bs2 md:w-[100%] sm:w-[100%] w-[75%]">
              <div className="flex flex-col gap-[20px] items-center justify-start w-[100%]">
                ...
                <div className="flex flex-col items-start justify-start w-[100%]">
                  ...
                  <Text
                    className="font-normal md:ml-[0] sm:ml-[0] ml-[24px] mt-[19px] not-italic text-gray_900_a2 text-left w-[auto]"
                    as="h5"
                    variant="h5"
                  >
