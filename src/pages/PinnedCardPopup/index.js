                            ...
                            <div className="absolute flex flex-col h-[max-content] inset-[0] items-center justify-start m-[auto] w-[auto]">
                              <div className="flex flex-col items-center justify-start w-[100%]">
                                ...
                                <Stack className="h-[55px] mt-[3px] relative w-[100%]">
                                  <div className="absolute flex flex-col h-[max-content] inset-[0] items-center justify-center m-[auto] w-[91%]">
                                    ...
                                    <List
                                      className="flex-col gap-[185px] md:gap-[40px] sm:gap-[40px] grid items-center mt-[62px] w-[99%]"
                                      orientation="vertical"
                                    >
                                    ...
                                    <div className="flex flex-col items-start justify-start mt-[308px] px-[8px] w-[192px]">
                                      <div className="bg-white_A700 flex flex-col gap-[2px] items-start justify-center p-[8px] md:self-stretch sm:self-stretch w-[100%]">
                                        <div className="flex flex-row items-center justify-between self-stretch w-[100%]">
                                          <div className="flex flex-row gap-[4px] items-center justify-start w-[auto]">
                                            <div className="bg-pink_A200 h-[1px] rounded-radius3 w-[8%]"></div>
                ...
                <div className="absolute bg-bluegray_50 border border-gray_900_19 border-solid flex flex-col items-center justify-start right-[29%] rounded-radius8 shadow-bs top-[7%] w-[26%]">
                  <div className="flex flex-col gap-[16px] items-end justify-start w-[100%]">
                    ...
                    <div className="flex flex-row gap-[12px] items-start justify-end ml-[auto] md:w-[100%] sm:w-[100%] w-[93%]">
                      <div className="flex flex-col gap-[12px] h-[567px] md:h-[auto] sm:h-[auto] items-start justify-start w-[auto]">
                        <List
                        ...
                        >
                          ...
                          <div className="bg-white_A700 flex flex-col items-start justify-center rounded-radius8 w-[257px]">
                            <div className="flex flex-col gap-[2px] items-start justify-center p-[8px] rounded-radius8 md:self-stretch sm:self-stretch w-[100%]">
                              ...
                              <div className="flex flex-col gap-[8px] items-start justify-start self-stretch w-[100%]">
                                <div className="flex flex-col gap-[8px] items-start justify-start md:w-[100%] sm:w-[100%] w-[53%]">
                                  <div className="flex flex-col gap-[8px] items-start justify-start md:w-[100%] sm:w-[100%] w-[78%]">
                                    <Text
                                      className="font-medium text-gray_900_a2 text-left w-[auto]"
                                      variant="body1"
                                    >
                                    ...
                                    <div className="flex flex-row items-center justify-start md:w-[100%] sm:w-[100%] w-[92%]">
                                      <div className="bg-orange_200 h-[6px] pb-[2px] px-[4px] rounded-radius3 w-[48%]"></div>
                                      <div className="bg-purple_A100 h-[6px] ml-[4px] pb-[2px] px-[4px] rounded-radius3 w-[48%]"></div>
                                    </div>
                                  </div>
                                ...
                                <div className="flex flex-col justify-center self-stretch w-[100%]">
                                  <Img
                                    src="images/img_ellipse45_38X38.png"
                                    className="h-[1px] md:h-[auto] sm:h-[auto] rounded-radius50 w-[100%]"
                        ...
                        <div className="bg-white_A700 flex flex-col items-start justify-center w-[257px]">
                          <div className="flex flex-col gap-[8px] items-start justify-start self-stretch w-[100%]">
                            <div className="flex flex-col items-start justify-center self-stretch w-[100%]">
                              <div className="flex flex-row gap-[8px] items-start justify-start w-[auto]">
                                <Img
                                  src="images/img_icondescriptio.svg"
                                  className="h-[1px] w-[14px]"
                                  alt="Icondescriptio Three"
                                />
                                <div className="flex flex-row gap-[4px] items-start justify-center w-[auto]">
                                  <Img
                                    src="images/img_iconmessage.svg"
                                    className="h-[1px] w-[14px]"
                                    alt="IconMessage Three"
                                  />
                                  <Text
                                    className="font-medium text-gray_900_90 text-left w-[auto]"
                                    variant="body3"
                        ...
                        <div className="bg-white_A700 flex flex-col items-start justify-center w-[257px]">
                          <div className="flex flex-col gap-[2px] items-start justify-center p-[8px] md:self-stretch sm:self-stretch w-[100%]">
                            <div className="flex flex-row items-center justify-between self-stretch w-[100%]">
                              <div className="flex flex-row gap-[4px] items-center justify-start w-[auto]">
                                <div className="bg-pink_A200 h-[1px] rounded-radius3 w-[9%]"></div>
                                <Text
                                  className="font-normal not-italic text-gray_900_90 text-left w-[auto]"
                                  variant="body2"
                                >
                            ...
                            <div className="flex flex-col gap-[8px] items-start justify-start self-stretch w-[100%]">
                              ...
                              <div className="bg-orange_200 h-[1px] pb-[2px] px-[4px] w-[18%]"></div>
                              <div className="bg-purple_A100 h-[1px] pb-[2px] px-[4px] w-[18%]"></div>
                              <div className="flex flex-col items-start justify-center self-stretch w-[100%]">
                                <div className="flex flex-row gap-[8px] items-start justify-start w-[auto]">
                                  <Img
                                    src="images/img_icondescriptio.svg"
                                    className="h-[1px] w-[14px]"
                                    alt="Icondescriptio Four"
                                  />
                                  <div className="flex flex-row gap-[4px] items-start justify-center w-[auto]">
                                    <Img
                                      src="images/img_iconmessage.svg"
                                      className="h-[1px] w-[14px]"
                                      alt="IconMessage Four"
                                    />
                                    <Text
                                      className="font-medium text-gray_900_90 text-left w-[auto]"
                                      variant="body3"
