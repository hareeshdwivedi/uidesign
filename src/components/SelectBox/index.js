...
const variants = {
  ...
  OutlineGray90019_1: "border border-gray_900_19 border-solid",
};
const shapes = { RoundedBorder6: "rounded-radius6" };
const sizes = {
  sm: "pt-[2px]",
  md: "py-[3px]",
  lg: "pb-[7px] pl-[7px] pt-[11px]",
  xl: "pl-[15px] py-[15px]",
};
        ...
        <Select
          ...
          styles={{
            ...
            option: (provided, state) => ({
              ...
              "&:hover": { backgroundColor: "#ffffff", color: "#070f21" },
            }),
...
SelectBox.propTypes = {
  ...
  variant: PropTypes.oneOf(["OutlineGray90019", "OutlineGray90019_1"]),
